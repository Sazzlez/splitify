...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* Outer: full viewport height, no page scroll */}
      <div style={{ height: '100dvh', display: 'flex', flexDirection: 'column', maxWidth: 480, margin: '0 auto', overflow: 'hidden' }}>
        ...
        {/* Bottom Nav – fixed height, never scrolls away */}
        <div style={{
          flexShrink: 0,
          background: 'var(--surface)', borderTop: '1px solid var(--border)',
          display: 'flex', padding: '8px 8px env(safe-area-inset-bottom, 12px)',
        }}>
          {tabs.map(t => (
